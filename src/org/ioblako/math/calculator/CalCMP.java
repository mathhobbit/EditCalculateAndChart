...
public class CalCMP implements CalcFunction {
String Report="";
public String getHelp(){
return "MP(A) is the Moore-Penrose inverse of A.";
}
...
int N =tmp.length;
             ...
             if( N > M)
                   throw new Exception("Number of rows in the matrix should be larger or equal to the number of its columns!?");
